...
<div class="form-group">
    ...
    <input type="email" name="email" placeholder="Insira o nome e-mail de acesso" class="form-control" value="<?php echo esc($usuario->email) ?>">
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="password" name="confirma_senha" placeholder="Confirme a senha de acesso" class="form-control">
</div>
<div class="custom-control custom-checkbox">
    <input type="hidden" name="ativo" value="0">
    <input type="checkbox" name="ativo" value="1" class="custom-control-input" id="ativo" <?php echo ($usuario->ativo) ? "checked" : "" ?>>
